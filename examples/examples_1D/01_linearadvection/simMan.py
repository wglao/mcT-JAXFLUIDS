...
class SimulationManager:
    ...
    def _feed_forward(self, primes_init: jnp.DeviceArray, n_steps: int, timestep_size: float, 
    ...
    def feed_forward(self, batch_primes_init: jnp.DeviceArray, n_steps: int, timestep_size: float, 
        t_start: float, output_freq: int = 1, ml_parameters_dict: Union[Dict, None] = None, 
        ml_networks_dict: Union[Dict, None] = None) -> Tuple[jnp.DeviceArray, jnp.DeviceArray]:
        ...
        :rtype: Tuple[jnp.DeviceArray, jnp.DeviceArray]
        """
        return jax.vmap(self._feed_forward, in_axes=(0,None,None,None,None,None,None), out_axes=(0,0,))(
            batch_primes_init, n_steps, timestep_size, t_start, output_freq, ml_parameters_dict, ml_networks_dict)
