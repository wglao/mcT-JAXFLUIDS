...
train_coefs = jnp.square(jrand.normal(train_key,(num_train,5))) + 1e-3 #strictly positive
test_coefs = jnp.square(jrand.normal(test_key,(num_test,5))) + 1e-3 #strictly positive
